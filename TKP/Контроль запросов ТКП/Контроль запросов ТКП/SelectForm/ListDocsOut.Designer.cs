namespace Контроль_запросов_ТКП.SelectForm
{
    partial class ListDocsOut
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "ListDocsOut";
            this.ShowIcon = false;
            this.ShowInTaskbar = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Список исходящих документов";
            this.Load += new System.EventHandler(this.ListDocsOut_Load);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.ListDocsOut_KeyDown);
